...
import React from 'react';
import { Baseline as Timeline, Target, Users, Award, Heart, Lightbulb, Handshake, Rocket, BarChart, Globe } from 'lucide-react';
...
const About = () => {
  ...
  const values = [
    ...
    { icon: Rocket, title: 'Enable, Don’t Just Offer', description: 'We don’t just give access — we enable success with services like onboarding, content creation, co-branding, and ads.' },
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                <Target className="h-8 w-8 text-blue-600 mr-2" /> Mission & Vision
              </h3>
              <p className="text-lg text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                <Target className="h-8 w-8 text-blue-600 mr-2" /> Our Mission
              </h3>
              <p className="text-lg text-gray-600 mb-4">
                At 99digicom, our mission is to democratize digital commerce by enabling brands of all sizes — from local artisans to emerging D2C leaders — to access, grow, and succeed across India’s leading e-commerce platforms.
              </p>
              <p className="text-lg text-gray-600">
                We aim to remove complexity, reduce barriers, and provide technology-backed, service-driven solutions that help our partners scale faster and smarter.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                <Timeline className="h-8 w-8 text-purple-600 mr-2" /> Our Vision
              </h3>
              <ul className="list-disc list-inside text-lg text-gray-600 space-y-2">
                ...
                <li>99digicom becomes India’s most trusted eCommerce enablement ecosystem, connecting product makers with digital buyers at scale.</li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <Lightbulb className="h-8 w-8 text-orange-600 mr-2" /> Our Core Values
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {values.map((value, index) => {
                  ...
                  return (
                    <div key={index} className="text-center group">
                      <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                <Target className="h-8 w-8 text-blue-600 mr-2" /> Our Long-Term Goals
              </h3>
              <ul className="list-disc list-inside text-lg text-gray-600 space-y-2">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              <p className="text-lg text-gray-600 mb-6">
                At 99digicom, we’re not just building a company — we’re enabling a movement that transforms the way India sells, scales, and collaborates.
              </p>
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <Link
                  to="/partner"
                  className="inline-block px-6 py-3 bg-gradient-to-br from-blue-600 to-purple-700 text-white font-semibold rounded-lg shadow-md hover:from-blue-700 hover:to-purple-800 transition-all"
                >
                  Become a Partner
                </Link>
                <Link
