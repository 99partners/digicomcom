...
import { Globe, Handshake, Megaphone, Truck, ArrowRight, Star, Play } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Join the Open Network for Digital Commerce (ONDC) effortlessly with our guided setup and compliance tools. Reach millions of customers across India.',
      benefit: 'Expand your market without complexity.'
    },
    {
      icon: Handshake,
      title: 'Strategic Brand Partnerships',
      description: 'Create impactful co-branded campaigns with customizable templates and shared analytics to boost visibility.',
      benefit: 'Strengthen your brand through trusted collaborations.'
    },
    {
      icon: Megaphone,
      title: 'Drive Traffic & Sales',
      description: 'Leverage SEO, social media, and targeted ads to attract and retain customers with tailored strategies.',
      benefit: 'Maximize ROI with data-driven campaigns.'
    },
    {
      icon: Truck,
      title: 'Streamlined Operations',
      description: 'Simplify shipping and fulfillment with our integrated logistics solutions, ensuring fast and reliable delivery.',
  ...
  return (
    <div className="pt-16">
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
              Empowering Businesses in the <span className="text-yellow-300">Digital Commerce Era</span>
            </h1>
            <p className="text-xl lg:text-2xl mb-8 text-blue-100 max-w-4xl mx-auto">
              Scale your business with seamless ONDC integration, strategic co-branding, and powerful digital marketing solutions.
            </p>
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-300"></div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Discover innovative solutions to grow your business in the digital age.</p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm font-medium text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity">
                    {feature.benefit}
                  </p>
                </div>
              );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-10">
              Start your journey with 99digicom.com today. Partner with us or explore our products to transform your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/partners"
              ...
              <Link
                to="/shop"
                className="inline-flex items-center px-8 py-4 border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold rounded-lg transition-all duration-300"
              >
                Explore Products
              </Link>
            </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Hear from our partners and customers who've thrived with 99digicom.com.</p>
          </div>
