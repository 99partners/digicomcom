...
const Jiomart = () => {
  ...
  const seo = t('marketplaces.jiomart.seo', { returnObjects: true });
  const header = t('marketplaces.jiomart.header', { returnObjects: true });
  const overview = t('marketplaces.jiomart.overview', { returnObjects: true });
  const requirements = t('marketplaces.jiomart.requirements', { returnObjects: true });
  const steps = t('marketplaces.jiomart.steps', { returnObjects: true });
  const commonQuestions = t('marketplaces.jiomart.commonQuestions.list', { returnObjects: true });
  const faq = t('marketplaces.jiomart.faq', { returnObjects: true });

  // Icon mapping for requirements
  const reqIcons = [User, Shield, CreditCard, Building, Package, User, Building, Package];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://99digicom.com/partners/marketplaces/jiomart" />
        ...
        <meta property="og:url" content="https://99digicom.com/partners/marketplaces/jiomart" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          url: "https://99digicom.com/partners/marketplaces/jiomart"
        })}</script>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col items-center justify-center mb-10">
            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center">
              <img src={JiomartLogo} alt="JioMart Logo" className="w-48 h-48 object-contain mb-4" loading="lazy" />
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8 border-t-4 border-green-500">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-green-700">{t('marketplaces.jiomart.commonQuestions.title')}</h2>
              </div>
