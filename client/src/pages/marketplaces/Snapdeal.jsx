...
const Snapdeal = () => {
  ...
  const seo = t('marketplaces.snapdeal.seo', { returnObjects: true });
  const header = t('marketplaces.snapdeal.header', { returnObjects: true });
  const overview = t('marketplaces.snapdeal.overview', { returnObjects: true });
  const requirements = t('marketplaces.snapdeal.requirements', { returnObjects: true });
  const steps = t('marketplaces.snapdeal.steps', { returnObjects: true });
  const commonQuestions = t('marketplaces.snapdeal.commonQuestions.list', { returnObjects: true });
  const resources = t('marketplaces.snapdeal.resources.list', { returnObjects: true });
  const notes = t('marketplaces.snapdeal.notes', { returnObjects: true });
  const cta = t('marketplaces.snapdeal.cta', { returnObjects: true });
  const faq = t('marketplaces.snapdeal.faq', { returnObjects: true });

  const reqIcons = [ShoppingBag, User, CreditCard, Building, Package, User];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://99digicom.com/partners/marketplaces/snapdeal" />
        ...
        <meta property="og:url" content="https://99digicom.com/partners/marketplaces/snapdeal" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          url: "https://99digicom.com/partners/marketplaces/snapdeal"
        })}</script>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col items-center justify-center mb-10">
            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center">
              <img src={SnapdealLogo} alt="Snapdeal Logo" className="w-48 h-48 object-contain mb-4" loading="lazy" />
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8 border-t-4 border-green-500">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-green-700">{t('marketplaces.snapdeal.commonQuestions.title')}</h2>
              </div>
          ...
          <section className="mb-12">
            <div className="bg-green-100 rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold text-green-700 mb-4">{resources.title}</h2>
              <ul className="list-disc ml-6 text-gray-700 space-y-2">
                {resources.map((res, idx) =>
                  res.url ? (
                    <li key={idx}>
                      <a href={res.url} className="text-green-700 underline" target="_blank" rel="noopener noreferrer">{res.name}</a>
                    </li>
                  ) : (
              ...
              <h2 className="text-2xl font-bold text-green-700 mt-8 mb-4">{notes.title}</h2>
              <ul className="list-disc ml-6 text-gray-700 space-y-2">
