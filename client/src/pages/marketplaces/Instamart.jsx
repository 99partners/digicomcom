...
const Instamart = () => {
  ...
  const seo = t('marketplaces.instamart.seo', { returnObjects: true });
  const header = t('marketplaces.instamart.header', { returnObjects: true });
  const overview = t('marketplaces.instamart.overview', { returnObjects: true });
  const requirements = t('marketplaces.instamart.requirements', { returnObjects: true });
  const steps = t('marketplaces.instamart.steps', { returnObjects: true });
  const faq = t('marketplaces.instamart.faq', { returnObjects: true });
  const cta = t('marketplaces.instamart.cta', { returnObjects: true });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://99digicom.com/partners/marketplaces/instamart" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          url: "https://99digicom.com/partners/marketplaces/instamart"
        })}</script>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col items-center justify-center mb-10">
            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center">
              <img src={InstamartLogo} alt="Instamart Logo" className="w-48 h-48 object-contain mb-4" loading="lazy" />
