...
const Flipkart = () => {
  ...
  const seo = t('marketplaces.flipkart.seo', { returnObjects: true });
  const header = t('marketplaces.flipkart.header', { returnObjects: true });
  const overview = t('marketplaces.flipkart.overview', { returnObjects: true });
  const requirements = t('marketplaces.flipkart.requirements', { returnObjects: true });
  const steps = t('marketplaces.flipkart.steps', { returnObjects: true });
  const commonQuestions = t('marketplaces.flipkart.commonQuestions.list', { returnObjects: true });
  const resources = t('marketplaces.flipkart.resources.list', { returnObjects: true });
  const notes = t('marketplaces.flipkart.notes', { returnObjects: true });
  const cta = t('marketplaces.flipkart.cta', { returnObjects: true });
  const faq = t('marketplaces.flipkart.faq', { returnObjects: true });

  // Icon mapping for requirements
  const reqIcons = [ShoppingBag, User, CreditCard, Building, User, Package];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://99digicom.com/partners/marketplaces/flipkart" />
        ...
        <meta property="og:url" content="https://99digicom.com/partners/marketplaces/flipkart" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          url: "https://99digicom.com/partners/marketplaces/flipkart"
        })}</script>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col items-center justify-center mb-10">
            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center">
              <img src={FlipkartLogo} alt="Flipkart Logo" className="w-48 h-48 object-contain mb-4" loading="lazy" />
          ...
          <section className="mb-12">
            <div className="bg-white rounded-lg shadow-md p-8 border-t-4 border-green-500">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-green-700">{t('marketplaces.flipkart.commonQuestions.title')}</h2>
              </div>
          ...
          <section className="mb-12">
            <div className="bg-green-100 rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold text-green-700 mb-4">{notes.title}</h2>
              ...
              <h2 className="text-2xl font-bold text-green-700 mt-8 mb-4">{resources.title}</h2>
              <ul className="list-disc ml-6 text-gray-700 space-y-2">
