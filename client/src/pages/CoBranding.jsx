...
//               {[
//                 { name: "Amazon", 
//                   desc: "World's largest e-commerce platform" },
//                 {
//                   name: "Flipkart",
...
//                 },
//                 { name: "Snapdeal", 
//                   desc: "Popular e-commerce platform"
//                  },
//               ].map((platform, index) => (
//                 <div
//                   key={index}
...
export default function CoBranding() {
  ...
  // Logo data array for Supported Marketplaces
  const marketplaceLogos = [
    { name: 'Amazon', src: amazonLogo, alt: 'Amazon Logo', desc: "World's largest e-commerce platform" },
    { name: 'Flipkart', src: flipkartLogo, alt: 'Flipkart Logo', desc: "India's leading e-commerce marketplace" },
    { name: 'JioMart', src: jiomartLogo, alt: 'JioMart Logo', desc: "Reliance's digital commerce platform" },
    { name: 'Meesho', src: meeshoLogo, alt: 'Meesho Logo', desc: "Social commerce platform" },
    { name: 'IndiaMART', src: indiamartLogo, alt: 'IndiaMART Logo', desc: "B2B marketplace for Indian businesses" },
    { name: 'Snapdeal', src: snapdealLogo, alt: 'Snapdeal Logo', desc: "Popular e-commerce platform" },
  ];
