        ...
        <header className="pt-24 pb-16 px-4 sm:px-6 md:px-10 bg-white">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              E-Commerce <span className="text-green-600">Profit</span> Calculators
            </h1>
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              Calculate your profit margins across different e-commerce platforms
            </p>
          </div>
        </header>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-wrap justify-center mb-8 gap-2 sm:gap-4">
              <button
                ...
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors ${activeCalculator === 'amazon' 
              ...
              <button
                ...
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors ${activeCalculator === 'flipkart' 
              ...
              <button
                ...
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors ${activeCalculator === 'meesho' 
