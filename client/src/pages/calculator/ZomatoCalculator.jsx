...
const ZomatoCalculator = () => {
  ...
  const [adCost, setAdCost] = useState('0'); // Advertising/Promotion cost
  ...
  const calculateProfit = () => {
    ...
    const feesBeforeGST = commission + gateway + ad;
  ...
  useEffect(() => {
    calculateProfit();
  }, [orderValue, costPrice, commissionPercent, gatewayPercent, gstPercent, adCost]);
  ...
  return (
    <div className="w-full">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6 border-b pb-2 border-gray-200">Zomato Profit Calculator</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Advertising/Promotion Cost</label>
              <input
                type="number"
                value={adCost}
                onChange={(e) => handleInputChange(e, setAdCost)}
                placeholder="0"
                className="block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 p-2"
              />
            </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between py-2 border-b border-gray-200">
              <span className="text-gray-600">Advertising/Promotion Cost:</span>
              <span className="font-medium">{formatCurrency(calculations.adCost)}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <div className="flex justify-between py-2 mt-2 bg-red-50 p-2 rounded-md">
...
export default ZomatoCalculator;
