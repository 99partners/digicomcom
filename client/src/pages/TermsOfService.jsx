  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <main className="pt-32 container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold mb-10 text-center text-green-700">Terms of Service</h1>
        <div className="space-y-8 text-base leading-7">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Accounts</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Intellectual Property</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Links to Other Sites</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Termination</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Governing Law</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-700 mb-2">Changes to These Terms</h2>
            <p className="text-gray-700">
