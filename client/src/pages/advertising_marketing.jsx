  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Boost your product visibility on Amazon, Flipkart & more with our performance marketing services. Get started with campaign setup from ₹4,999. Drive more sales today!" />
      ...
      <main className="min-h-screen bg-gradient-to-br from-green-50 to-white">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-4xl mx-auto">
                In today's competitive e-commerce landscape, visibility is key to driving sales. If your product isn't visible, it's likely to be overlooked. Optimised advertising ensures you stand out in crowded marketplaces.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-6" role="list">
              {[
                ...
                },
                {
                  ...
                  description: "Improve visibility with strategic ad placements on platforms like Amazon, Flipkart, and more."
                },
                {
                  icon: <Users className="h-8 w-8 text-green-600 mb-4" aria-hidden="true" />,
                  title: "High-Intent Buyers",
                  description: "Attract customers who are ready to buy, using targeted campaigns to focus on high-conversion keywords and ads aimed at active shoppers."
                }
              ].map((item, index) => (
              ...
              <div className="space-y-6" role="list">
                {[
                  ...
                  },
                  {
                    ...
                    description: "We track campaign performance through detailed analytics and deliver regular reports, offering actionable insights to continuously improve results."
                  }
                ].map((item, index) => (
        ...
        {/* Success Story */}
        <section aria-labelledby="success-story-heading" className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 id="success-story-heading" className="text-3xl font-bold text-gray-900 mb-4">Success Story</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="bg-green-50 rounded-lg p-8">
              <p className="text-gray-700 mb-6">
                We partnered with a home decor brand to enhance its product visibility through targeted Amazon Sponsored Ads and Flipkart PLA campaigns. By optimising product listings and running seasonal promotions, we helped the brand achieve:
              </p>
              <ul className="space-y-4 mb-6">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-600 mr-3" />
                  <span>Enhanced product positioning through strategic keyword targeting</span>
                </li>
              </ul>
              <p className="text-gray-700">
                Our approach helped the brand grow rapidly by boosting visibility on key platforms, leading to increased customer engagement and sales.
              </p>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="platforms-heading" className="py-16 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" role="list">
              {[
                { name: "Amazon", desc: "World's largest e-commerce platform with millions of daily shoppers." },
                { name: "Flipkart", desc: "India's leading e-commerce marketplace, offering extensive reach within India." },
                { name: "Meesho", desc: "A growing social commerce platform focusing on direct-to-consumer selling via social media channels." },
                { name: "Jiomart", desc: "Reliance's digital commerce platform, catering to a wide range of consumer goods." },
                { name: "IndiaMART", desc: "A B2B marketplace providing access to bulk buyers and a large network of suppliers." },
                { name: "Snapdeal", desc: "A popular e-commerce platform that serves millions of buyers across India." },
              ].map((platform, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6" role="listitem">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto text-center">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-green-50 rounded-lg p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Start Your Campaign Today – ₹4,999</h3>
                <p className="text-gray-600 mb-6">Ready to drive sales? Get started with our tailored advertising campaigns designed for e-commerce success.</p>
                <a href="#get-started" className="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors">
                  Get Started Now
              ...
              <div className="bg-green-50 rounded-lg p-8">
                ...
                <p className="text-gray-600 mb-6">Unsure where to start? Book a free consultation with our experts and discover the best strategy for your business.</p>
                <a href="#contact" className="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors">
                  Book Consultation
                  <ArrowRight className="ml-2 h-5 w-5" />
                </a>
              </div>
