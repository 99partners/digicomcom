...
const Header = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        {
          name: t("Why Partners With Us?"),
          href: "/partners/why_Partners_with_us",
        },
        {
          name: t("Partners Onboarding"),
          href: "/partners/partners_Onboarding",
        },
      ],
    },
    {
        ...
        >
          {navigation.map((item, index) => (
            <div
              ...
              onMouseEnter={
                item.submenu ? () => setActiveDropdown(item.name) : undefined
              }
              onMouseLeave={
                item.submenu ? () => setActiveDropdown(null) : undefined
              }
            >
              {item.submenu ? (
              ...
              {item.submenu ? (
                <div className="mb-1">
                  ...
                  <div
                    ...
                    aria-hidden={
                      activeDropdown === item.name ? "false" : "true"
                    }
                  >
                    {item.submenu.map((subItem) => (
                      <Link
