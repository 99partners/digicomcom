    ...
    if (this.state.hasError) {
      return (
        <div className="bg-red-100 text-red-700 p-4 text-center">
          <h2>Error in Header Component</h2>
          <p>{this.state.error?.message || "An unexpected error occurred."}</p>
          <p>
            Please check the console for details and ensure all images are in
            public/assets/.
          </p>
        </div>
      );
...
const Header = () => {
  ...
  // Mapping object for marketplace keys to image imports
  const imageMap = {
    amazon: amazonLogo,
      ...
      services: [
        {
          ...
          description:
            "Showcase your business with a stunning, professional online presence",
        },
        {
          title: "Brand Store",
          description:
            "Running a business can be incredibly demanding, leaving little time for consistent brand promotion.",
        },
        {
          title: "Listing and Cataloging",
          description:
            "100% of successful brands use business phone numbers to significantly enhance their growth potential.",
        },
        {
          title: "A+ Listing",
          description:
            "We offer the expertise of a dedicated account manager for your business.",
        },
        {
          title: "Advertising",
        ...
        },
        {
          ...
          description:
            "Comprehensive account management services for Glowroad sellers",
        },
      ],
    },
    flipkart: {
      ...
      services: [
        {
          title: "Account Management",
          description:
            "Comprehensive B2B account management and optimization services",
        },
        {
          title: "Lead Management",
          description:
            "Advanced lead tracking, qualification, and response management system",
        },
        {
          title: "Catalog Optimization",
          description:
            "Professional product catalog creation and optimization for B2B visibility",
        },
        {
          title: "Buy Lead Subscription",
          description:
            "Strategic management of buy leads and subscription optimization",
        },
        {
          title: "Premium Listing",
          description:
            "Enhanced visibility with premium listing and category-specific optimization",
        },
        {
          title: "Business Analytics",
          description:
            "Detailed analytics and insights for better business decision making",
        },
      ],
    },
    snapdeal: {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            "Comprehensive performance tracking and business insights",
        },
        {
    ...
    { name: "About Us", href: "/about" },
    {
      ...
      submenu: [
        ...
        { name: "Account Management Service", href: "/services/ams" },
        {
          ...
          href: "/services/advertising_marketing",
        },
  ...
  if (pathname === "/customerlogin" || pathname === "/partnerlogin")
    return null;

  return (
    <ErrorBoundary>
      <header
        className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md shadow z-50 border-b border-gray-100"
        role="banner"
      >
          ...
          <div className="flex-shrink-0">
            ...
            >
              <img
                ...
                onError={(e) => {
                  console.error(
                    `Failed to load 99digicom logo at ${new Date().toISOString()}`
                  );
                ...
                {item.submenu ? (
                  <div className="relative">
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm px-4 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap relative z-10 ${
                        isActive(
                          item.submenu.find((sub) => sub.href === pathname)
                            ?.href
              ...
              {activeDropdown === "Partners" ? (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {Object.entries(marketplaces).map(
                          ([key, marketplace]) => (
                            <div
                              ...
                              onClick={() =>
                                handleMenuItemClick(marketplace.href)
                              }
                    ...
                    >
                      {activeMarketplace &&
                      imageMap[activeMarketplace] &&
                      marketplaces[activeMarketplace] ? (
                        <div className="bg-gray-50 rounded-lg p-8">
                          {/* Marketplace Logo */}
                          <div className="mb-8 flex justify-center">
                            <img
                              src={imageMap[activeMarketplace]}
                            ...
                            {marketplaces[activeMarketplace].services.map(
                              (service, index) => (
                                <Link
                                  ...
                                  onClick={() =>
                                    handleMenuItemClick(
                                      marketplaces[activeMarketplace].href
                                    )
                                  }
                        ...
                        <div className="bg-gray-50 rounded-lg p-8 text-center text-gray-600">
                          Select a marketplace to view details
                        </div>
                      )}
                    </div>
                  </div>
